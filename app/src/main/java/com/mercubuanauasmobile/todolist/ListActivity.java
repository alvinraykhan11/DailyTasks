...
public class ListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void deletePastToDo() {
        ...
        if (rowsDeleted == 0) {
            Toast.makeText(this, "There isn't any Past DailyTasks to be deleted!",
        ...
        getSupportActionBar().setTitle("DailyTasks");
        today = false;
        textEmptySubtitle.setText("UAS MOBILE PROGRAMMING");
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setMessage("Are you sure, you want to delete ALL Past DailyTasks?");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String currentDate = DateFormat.getDateInstance(android.icu.text.DateFormat.FULL)
    ...
    protected void onResume() {
        super.onResume();
        mCursorAdapter.swapCursor(null);
        getSupportActionBar().setTitle("Your's All DailyTask");
        today = false;
        textEmptySubtitle.setText("UAS MOBILE PROGRAMMING");
        getSupportLoaderManager().initLoader(TODO_LOADER_ALL, null, this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.todayToDo:
                getSupportActionBar().setTitle("Today's DailyTask");
                mCursorAdapter.swapCursor(null);
                today = true;
                textEmptySubtitle.setText("Add a DailyTask of current date (Today) to get Visible here");
            ...
            case R.id.allToDo:
                ...
                mCursorAdapter.swapCursor(null);
                today = false;
                textEmptySubtitle.setText("UAS MOBILE PRODRAMMING");
                getSupportLoaderManager().initLoader(TODO_LOADER_ALL, null, this);
                return true;
        }
