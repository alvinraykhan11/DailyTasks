...
import com.mercubuanauasmobile.todolist.data.ToDoContract;
...
public class ToDoActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void Notification() {
        ...
        notificationIntent.putExtra("Event", event_todo);
    ...
    private void deleteToDo() {
        ...
        cancelNotification();
        if (rowsDeleted == 0) {
            Toast.makeText(this, "Error with deleting DailyTasks",
                    Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Deletion of DailyTasks Successfully",
                    Toast.LENGTH_SHORT).show();
        }
        // Close the activity
        finish();
    ...
    public void updateIntoDatabase() {
        ...
        values.put(ToDoContract.ToDoEntry.COLUMN_EVENT, event_todo);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heading = findViewById(R.id.heading_ToDo);
        message = findViewById(R.id.message_list);
        event = findViewById(R.id.event_list);
        date = findViewById(R.id.date_ToDo);
        time = findViewById(R.id.time_ToDo);
        NotificationText = findViewById(R.id.notificationText);
        nSwitch = findViewById(R.id.notificationSwitch);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        String[] projection = {
                ...
                ToDoContract.ToDoEntry.COLUMN_EVENT,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int eventColumnIndex = cursor.getColumnIndex(ToDoContract.ToDoEntry.COLUMN_EVENT);
            ...
            event_todo = cursor.getString(eventColumnIndex);
            ...
            String day_string = Character.toString(date_todo.charAt(0)) + date_todo.charAt(1);
            String month_string = Character.toString(date_todo.charAt(5)) + date_todo.charAt(6);
            String year_string = Character.toString(date_todo.charAt(10)) + date_todo.charAt(11) +
                    date_todo.charAt(12) + date_todo.charAt(13);

            DAY = Integer.parseInt(day_string);
            MONTH = Integer.parseInt(month_string);
            YEAR = Integer.parseInt(year_string);

            String minute_string = Character.toString(time_todo.charAt(5)) + time_todo.charAt(6);
            MINUTE = Integer.parseInt(minute_string);

            String hour_string = Character.toString(time_todo.charAt(0)) + time_todo.charAt(1);
            ...
            event.setText(event_todo);
            date.setText(date_todo);
            time.setText(time_todo);

            Log.i("NOTIFICATION DAILYTASKS", Integer.toString(notification_todo));
            ...
            if (notification_todo != 2) {
                try {
                    ...
                    String day_string1 = Character.toString(current_date_string.charAt(0)) + current_date_string.charAt(1);
                    String month_string1 = Character.toString(current_date_string.charAt(5)) + current_date_string.charAt(6);
                    String year_string1 = Character.toString(current_date_string.charAt(10)) + current_date_string.charAt(11) +
                            current_date_string.charAt(12) + current_date_string.charAt(13);
                    ...
                    String minute_string1 = Character.toString(current_time_string.charAt(5)) + current_time_string.charAt(6);
                    MINUTE_CURRENT = Integer.parseInt(minute_string1);

                    String HOUR_CURRENT_string = Character.toString(current_time_string.charAt(0)) + current_time_string.charAt(1);
            ...
            if (notification_todo == 2) {
                ...
                NotificationText.setText("Daily Tasks already !");
            } else {
