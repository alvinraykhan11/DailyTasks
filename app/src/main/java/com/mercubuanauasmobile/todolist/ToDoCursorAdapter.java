...
public class ToDoCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView message_list = (TextView) view.findViewById(R.id.message_list);
        TextView event_list = (TextView) view.findViewById(R.id.event_list);
        ...
        int messageColIndex = cursor.getColumnIndex(ToDoContract.ToDoEntry.COLUMN_MESSAGE);
        int eventColIndex = cursor.getColumnIndex(ToDoContract.ToDoEntry.COLUMN_EVENT);
        ...
        String message = cursor.getString(messageColIndex);
        String event = cursor.getString(eventColIndex);
